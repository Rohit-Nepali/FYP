...
export default function InviteMemberModal({
    ...
    const { showAlert, showError, showValidationError, AlertComponent } = useAlert();
    ...
    const handleInvite = async () => {
        ...
        try {
            setInviting(true);
            await inviteProjectMember(projectId, normalizedEmail, "member");

            showAlert({
                title: "Success",
                message: "Invitation sent successfully. The user can accept or decline from notifications.",
                type: "success",
                confirmText: "OK",
                onConfirm: () => {
                    setEmail("");
