...
import { Task, uploadAttachments, deleteTask } from "@/src/services/taskService";
                  ...
                  <>
                    ...
                    >
                      <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                        className={`min-w-[58px] items-center rounded-[10px] border px-[10px] py-2 ${!assigneeId ? "border-[#2563EB] bg-[#1E3A8A]" : "border-[#4B5563] bg-[#374151]"
                          }`}
                      >
                      ...
                      {projectMembers.map((m) => (
                        <TouchableOpacity
                          ...
                          activeOpacity={0.7}
                          className={`min-w-[58px] items-center rounded-[10px] border px-[10px] py-2 ${assigneeId === m.id ? "border-[#2563EB] bg-[#1E3A8A]" : "border-[#4B5563] bg-[#374151]"
                            }`}
                        >
                          {m.profileImage ? (
