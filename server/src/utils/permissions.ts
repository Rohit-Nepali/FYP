/**
 * RBAC Permission Utility Module
 * Centralized permission logic for Taskora
 * 
 * This module provides functions to compute user permissions for tasks and projects.
 * Used by both controllers and services to maintain consistent authorization logic.
 */
